...
For manual assistant skill directories, copy the packaged `skills/terrashark/` directory into the target skills folder. For Codex, clone the repository into your project and reference `.terrashark/skills/terrashark/SKILL.md` from `AGENTS.md`.
